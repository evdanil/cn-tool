...
## Features:
- Performs IP/Subnet/DNS/Site information lookups
- Performs configuration checks across configuration storage (`/opt/data/configs/cisco/routers/`) for obsolete configuration when device being removed (cleanups on BGP borders/prefixes/ACLs)
